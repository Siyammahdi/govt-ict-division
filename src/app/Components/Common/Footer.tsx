...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#006a4e] to-[#188f00] dark:from-[#064e3b] dark:to-[#14532d] p-14 text-white shadow-sm">
      <div className="w-full flex flex-col md:flex-row justify-between">
        {/* Left Section */}
        <div className="md:w-2/5 mb-10 md:mb-0">
          <div className="flex items-center gap-5">
            <Image src="/logo.png" alt="logo" height={50} />
            <h3 className="text-4xl font-normal">ICT Division</h3>
          </div>
          ...
          <p className="text-secondary text-sm font-normal">Siyammahdi©2024</p>
        </div>
        ...
        <div className="md:w-1/5">
          ...
          <Image className="bg-white p-4" src="/footer/np-logo-set.png" alt="icon" />
        </div>
      </div>
    </footer>
  );
