...
const Hero = () => {
  return (
    <ComponentLayout>
      <div className="flex flex-col md:flex-row py-16 px-10 lg:px-0 md:py-36">
        <div className="flex flex-col items-center md:items-start gap-6 md:gap-10 md:w-1/2">
          ...
          <div className="space-y-4 text-center md:text-left">
            <h1 className="text-3xl md:text-5xl font-semibold">ICT Division</h1>
            <p className="text-lg md:text-[20px]">{text}</p>
          </div>
